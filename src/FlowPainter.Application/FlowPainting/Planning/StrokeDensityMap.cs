...
public sealed class StrokeDensityMap
{
    private readonly double[] _values;

    public StrokeDensityMap(ImageSize size, ReadOnlySpan<double> values)
    {
    ...
    public static StrokeDensityMap CreateUniform(ImageSize size, double density)
    {
        ...
        return new StrokeDensityMap(size, values);
    }
}
