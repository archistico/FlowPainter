...
- continuous M15.1 regional boundary distance, strength, tangent, normal and hardness guidance;
- M15.2 continuous local stroke length, width, segment, curve, tangent-alignment and crossing-resistance policy;
- 1,071 validated automated test cases across Domain, Application, Imaging and Rendering;
...
- [`docs/NEXT_STEPS_AFTER_M15_2.md`](docs/NEXT_STEPS_AFTER_M15_2.md) — approved implementation order and dependency map
- [`docs/M15_3_STAGED_FLOW_RENDERING.md`](docs/M15_3_STAGED_FLOW_RENDERING.md)
- [`docs/M15_4_PRIMITIVE_COARSE_TO_FINE.md`](docs/M15_4_PRIMITIVE_COARSE_TO_FINE.md)
- [`docs/M15_5_UNIFIED_ARTISTIC_HIERARCHY.md`](docs/M15_5_UNIFIED_ARTISTIC_HIERARCHY.md)
- [`docs/M16_ADVANCED_REGIONAL_EDITING.md`](docs/M16_ADVANCED_REGIONAL_EDITING.md)
- [`docs/M17_HIGH_RESOLUTION_OPTIMIZATION_RELEASE.md`](docs/M17_HIGH_RESOLUTION_OPTIMIZATION_RELEASE.md)
