...
- 804 validated automated test cases across Domain, Application, Imaging and Rendering;
...
- 863 expected cases after M14.1, pending local build/test validation.
